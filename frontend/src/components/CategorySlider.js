...
export default function CategorySlider({ history }) {
  return (
    <div
      ...
      className=" tw-text-xs category-slider  tw-px-2 tw-my-3   tw-items-center tw-overflow-x-scroll tw-font-semibold tw-flex tw-tracking-wider tw-text-gray-800 tw-antialiased tw-leading-wide"
    >
      <div
