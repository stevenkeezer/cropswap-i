...
export default function CategorySlider({ history }) {
  return (
    <div
      ...
      className=" tw-text-xs category-slider  tw-px-2 tw-my-2  tw-h-6 tw-items-center tw-overflow-x-scroll tw-font-semibold tw-flex tw-tracking-wider tw-text-gray-900 tw-text-opacity-75 tw-antialiased tw-leading-wide"
    >
      <div
