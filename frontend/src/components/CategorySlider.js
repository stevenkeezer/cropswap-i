...
export default function CategorySlider() {
  return (
    <div
      ...
      className="tw-gap-4 tw-text-xs category-slider  tw-px-4   tw-items-center tw-overflow-x-scroll  tw-flex tw-tracking-wide  tw-mt-6 tw-pt-1"
    >
      <div
        // onClick={(e) => searchHandler("seasonal")}
        className="hover:tw-text-teal-700  tw-font-semibold tw-text-gray-700 tw-cursor-pointer"
      >
        Seasonal
      </div>
