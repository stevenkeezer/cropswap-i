  ...
  return (
      ...
      <div className="tw-flex tw-justify-center tw-gap-5">
        <div class="tw-py-3 tw-text-center tw-focus:outline-none tw-border-8 tw-border-white tw-px-1">
          <div class="  tw-h-auto -tw-pb-8 tw-w-full  tw-py-1  tw-mx-auto tw-text-gray-900 tw-hover:bg-green-500 tw-border-2 tw-border-transparent tw-hover:text-white   tw-rounded-lg tw-hover:shadow-lg">
            <svg
              ...
              class="tw-w-24 tw-h-24 hover:tw-bg-gray-300 tw-bg-gray-300 hover:t tw-rounded-full tw-p-4 tw-text-gray-900 tw-border  tw-shadow  tw-mx-auto  "
              version="1.1"
              id="Layer_1"
        ...
        <div class="tw-py-3 tw-text-center tw-focus:outline-none tw-border-8 tw-border-white tw-px-1">
          <div class="  tw-h-auto -pb-8 tw-w-full  tw-py-1  tw-mx-auto tw-text-gray-900  tw-hover:bg-green-500 tw-border-2 tw-border-transparent tw-hover:text-white   tw-rounded-lg tw-hover:shadow-lg">
            <svg
              class="tw-w-24 tw-h-24 hover:tw-bg-gray-300 tw-rounded-full tw-p-4  text-gray-900 hover:text-white mx-auto my-auto opacity-75"
              version="1.1"
              id="Layer_1"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
        ...
        <div class="tw-py-3 tw-text-center tw-focus:outline-none tw-border-8 tw-border-white tw-px-1">
          <div class="  tw-h-auto -pb-8 tw-w-full  tw-py-1  tw-mx-auto tw-text-gray-900  tw-hover:bg-green-500 tw-border-2 tw-border-transparent tw-hover:text-white   tw-rounded-lg tw-hover:shadow-lg">
            <svg
              class="tw-w-24 tw-h-24 hover:tw-bg-gray-300 tw-rounded-full tw-p-4  text-gray-900 tw-hover:text-white tw-mx-auto  "
              version="1.1"
              id="Layer_1"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
	...
	c0.042,0.161,0.071,0.327,0.071,0.501C38.959,26.998,38.778,27.439,38.489,27.787z"
        ...
        <div class="tw-py-3 tw-text-center tw-focus:outline-none tw-border-8 tw-border-white tw-px-1">
          <div class="  tw-h-auto -pb-8 tw-w-full  tw-py-1  tw-mx-auto tw-text-gray-900  tw-hover:bg-green-500 tw-border-2 tw-border-transparent tw-hover:text-white   tw-rounded-lg tw-hover:shadow-lg">
            <svg
              class="tw-w-24 tw-h-24 hover:tw-bg-gray-300 tw-rounded-full tw-p-4  tw-hover:text-white tw-mx-auto  "
              version="1.1"
              id="Layer_1"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
