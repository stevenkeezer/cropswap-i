    ...
    <>
      ...
      <EuiPage className="tw-px-0 sm:tw-px-0 tw-bg-white tw-min-h-screen lg:tw-bg-gray-200 lg:tw-bg-opacity-25">
        <div className=" sm:tw-mx-auto ">
          ...
          <EuiPageContentBody className="tw-flex tw-flex-col tw-gap-8 md:tw-flex-row tw-mx-auto tw-max-w-screen-xl  tw-justify-center tw-pb-4 tw-text-gray-800 tw-mt-4  lg:tw-mt-8 tw-mx-auto">
