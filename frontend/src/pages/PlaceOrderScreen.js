      ...
      <Container>
        ...
        <Row>
                  ...
                  {cart.cartItems.length === 0 ? (
                    ...
                    <ListGroup variant="flush">
                      {cart.cartItems.map((item, index) => (
                        <ListGroup.Item key={index} className="tw-border-none">
                          <Row>
                            <Col md={1}>
                              <Image
                                src={item.image}
          ...
          <Col md={4}>
            ...
            <Card className="tw-border-none tw-rounded tw-shadow tw-pt-4">
              <ListGroup variant="flush">
                <ListGroup.Item className="tw-border-none">
                  <Row>
                    <Col>Items</Col>
                    <Col className="tw-text-right">${cart.itemsPrice}</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item className="tw-border-none">
                  <Row>
                    <Col>Shipping</Col>
                    <Col className="tw-text-right">${cart.shippingPrice}</Col>
                  </Row>
                </ListGroup.Item>
                ...
                <ListGroup.Item className="tw-border-none">
                  <Row>
                    <Col>Tax</Col>
                    <Col className="tw-text-right">${cart.taxPrice}</Col>
                  </Row>
                </ListGroup.Item>
                <ListGroup.Item className="tw-border-none">
                  <Row>
                    <Col>Sub total</Col>
                    <Col className="tw-text-right">${cart.totalPrice}</Col>
                  </Row>
                </ListGroup.Item>
            ...
            <p className="tw-text-xs tw-pt-3">
