        ...
        <div className=" sm:tw-mx-auto sm:tw-px-4">
          ...
          <div className=" tw-max-w-screen-xl  sm:tw-mx-auto tw-flex tw-flex-col lg:tw-flex-row">
            <div className=" tw-w-full">
              <div className=" tw-text-xl  sm:tw-pt-4 tw-pt-0  tw-pb-3 tw-max-w-screen-lg ">
            ...
            <div className="lg:tw-w-3/5 tw-mt-5 lg:tw-mt-0 tw-w-full">
              <div className="w-full tw-px-4 tw-border-none sm:tw-mx-4 tw-shadow-md sm:tw-shadow tw-rounded tw-bg-white  ">
