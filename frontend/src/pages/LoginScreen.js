    ...
    <>
      {userInfo ? (
        ...
        <>
            ...
            <EuiPageBody component="div">
              ...
              >
                <EuiPageContentHeader>
                  <EuiPageContentHeaderSection
                    verticalPosition="center"
                    className="tw-flex tw-mx-auto"
                  >
                    <IonImg
                      className="tw-shadow tw-border tw-my-1 tw-flex tw-mt-2 tw-cursor-pointer "
                      onClick={(e) => {
                        history.push("/");
                      }}
                      style={{
                ...
                <EuiPageContentBody>
                  <div class="tw-w-full tw-">
                    ...
                    <div class="tw-flex tw-items-center tw-w-full tw-mt-2">
                      <div class="tw-w-full tw-pt-4 tw-mx-2 tw-border-t  tw-border-gray-400">
                        <button class="tw-appearance-none tw-flex tw-items-center tw-px-12 tw-justify-center tw-block tw-w-full tw-bg-gray-100 tw-text-gray-700 tw-shadow tw-border tw-border-gray-500 tw-rounded-lg tw-py-3 tw-leading-tight hover:tw-bg-gray-200 hover:tw-text-gray-700 focus:tw-outline-none">
                          <svg
                      ...
                      <div class="tw-w-full md:tw-w-1/3 tw-pt-4 tw-mx-2">
                        <button class="tw-appearance-none tw-flex tw-items-center tw-px-12 tw-justify-center tw-block tw-w-full tw-bg-gray-100 tw-text-gray-700 tw-shadow tw-border tw-border-gray-500 tw-rounded-lg tw-py-3 tw-px-3 tw-leading-tight hover:tw-bg-gray-200 hover:tw-text-gray-700 focus:tw-outline-none">
                          <svg
                            class="tw-h-6 tw-w-6 tw-fill-current tw-text-gray-700"
                            viewBox="0 0 512 512"
                          >
                      ...
                      <div class="tw-w-full   tw-pt-4 tw-mx-2 tw-border-t tw-border-gray-400">
                        <button
                          aria-disabled="true"
                          class="tw-appearance-none tw-flex tw-items-center tw-px-12  tw-justify-center tw-block tw-w-full tw-bg-gray-100 tw-text-gray-700 tw-shadow tw-border tw-border-gray-500 tw-rounded-lg tw-py-3 tw-px-3 tw-leading-tight hover:tw-bg-gray-200 hover:tw-text-gray-700 focus:tw-outline-none"
                        >
                          <svg
                            class="tw-h-6 tw-w-6 tw-fill-current tw-text-gray-700"
                            viewBox="0 0 512 512"
          ...
          {/* <div class="tw-text-center tw-items-center tw-flex tw-justify-center ">
